...
contract Djob{
    ...
    address payable[] public cliants;
    ...
    function postjob(string memory name,string memory jdesc,uint budjet,string memory jloc,string memory jmode) external{
        ...
        nextID++;
        cliants.push(payable(msg.sender));
    ...
    function getcliants() public view returns(address payable[] memory){
...
// 0x2731685d9EdD773FB5554Da87C4580790E310D18

// ganache contract address0xB4c04f83FeAcbcEA703e6aB9C9311921E3817619